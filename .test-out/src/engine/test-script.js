...
const normalBleed = (0, xpEngine_1.calculateCurrentRivalBleed)(400, dayStart, Date.now(), false);
...
const streakBleed = (0, xpEngine_1.calculateCurrentRivalBleed)(400, dayStart, Date.now(), true);
...
const cappedBleed = (0, xpEngine_1.calculateCurrentRivalBleed)(400, sixteenHoursAgo, Date.now(), false);
...
const normalXP = (0, xpEngine_1.applyCleanDayBonus)(playerXPWithoutBonus, false);
const cleanDayXP = (0, xpEngine_1.applyCleanDayBonus)(playerXPWithoutBonus, true);
...
assert((0, xpEngine_1.getDayResult)(800, 750) === 'player', "Player wins when player XP >= rival XP");
assert((0, xpEngine_1.getDayResult)(600, 800) === 'rival', "Rival wins when player XP < rival XP");
// Test 6: Level Adjustments
assert((0, xpEngine_1.updateRivalLevel)(14, 'rival') === 15, "Rival level increases by 1 on loss");
assert((0, xpEngine_1.updateRivalLevel)(14, 'player') === 13, "Rival level decreases by 1 on win");
assert((0, xpEngine_1.updateRivalLevel)(50, 'rival') === 50, "Rival level caps at 50 on loss");
assert((0, xpEngine_1.updateRivalLevel)(1, 'player') === 1, "Rival level bottoms at 1 on win");
// Test 7: Evolution Form Identification
assert((0, xpEngine_1.getEvolutionForm)(45) === 1, "Level 45 should yield powered form (1)");
assert((0, xpEngine_1.getEvolutionForm)(14) === 0, "Level 14 should yield base form (0)");
assert((0, xpEngine_1.getEvolutionForm)(2) === 2, "Level 2 should yield degraded form (2)");
